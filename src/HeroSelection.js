      ...
      <section className="heroSelect">
        ...
        <form action="submit" onSubmit={props.handleHeroChoice}>
          <fieldset onChange={props.handleHeroSelection} className="heroSelectForm">
              ...
              <label className="heroInputContainer" htmlFor="hero1">{heroes[0].name}<img className="heroPortrait" src={Lukeskywalker} alt="portrait of Luke Skywalker" /></label>
  
              <input type="radio" id="hero2" name="hero" value="1"/>
              <label className="heroInputContainer" htmlFor="hero2">{heroes[1].name}<img className="heroPortrait" src={moana} alt="Portrait of Moana" /></label>
